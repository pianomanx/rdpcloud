...
const (
	Termserv_LogoffUser_FullMethodName   = "/services.termserv.Termserv/LogoffUser"
	Termserv_LogoffMyUser_FullMethodName = "/services.termserv.Termserv/LogoffMyUser"
)
...
func (c *termservClient) LogoffUser(ctx context.Context, in *LogoffUserRequest, opts ...grpc.CallOption) (*LogoffUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Termserv_LogoffUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *termservClient) LogoffMyUser(ctx context.Context, in *LogoffMyUserRequest, opts ...grpc.CallOption) (*LogoffMyUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Termserv_LogoffMyUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Termserv_LogoffUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Termserv_LogoffUser_FullMethodName,
	}
...
func _Termserv_LogoffMyUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Termserv_LogoffMyUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
